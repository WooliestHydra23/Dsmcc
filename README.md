...
- AI/LLM workflow design (ChatGPT, Claude, RAG systems)
- Python scripting and data pipeline development
- Product documentation and technical communication
- Enterprise software workflow documentation

### **Tools & Platforms**
- **Languages**: Python, PowerShell, VBA
- **AI/ML**: ChatGPT, Claude, RAG systems, prompt engineering
- **Business**: PowerPoint, Excel, Google Sheets, Notion
- **Creative**: Canva, Obsidian, DaVinci Resolve
